#Hola, ahora que ya sabemos construir una interacción bsica con nuestro programa
...
#
#Una caracterí­stica de los programas con mÃºltiples funcionalidades es que ofrecen un menÃº de acciones
