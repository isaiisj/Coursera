        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    bookingManager.addNewBooking(keyboard.nextLine());
                    break;
                case 2:
                    ...
                    bookingManager.cancelBooking(keyboard.nextLine());
                    break;
                case 3:
                    ...
                    System.out.println("Enter the seat number you want to update: ");
                    String oldSeatNumber = keyboard.nextLine();
                    System.out.println("Enter the new seat number you want: ");
