public class Main {
    ...
    public static void main(String[] args) {
        ...
        int titleLength = bookTitle.length(); // TODO: find out the length of bookTitle
        ...
        String shortBookTitle = bookTitle.substring(0,maxLength);// TODO: shorten the bookTitle to 20 characters
        ...
        boolean containsWord = bookTitle.contains(searchWord);// TODO: check if searchWord is present in bookTitle.
