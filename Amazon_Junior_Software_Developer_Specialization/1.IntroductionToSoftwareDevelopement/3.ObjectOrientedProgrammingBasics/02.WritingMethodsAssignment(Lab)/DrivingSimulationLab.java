...
// like turn the engine on/off, accelerate (i.e. increase the speed) and apply the breaks.
public class DrivingSimulationLab {
    ...
    public static void changeGear() {
        ...
        System.out.println("Please select your gear option: ");
...
/** Isolate functionality of each method**/

// TODO 1: toggleEngine should turns the engine on or off based on user's input

// TODO 2: changeGEar should enables the user to change the car's engine.

// TODO 3: accelerate should allow  acceleration only if engine is on and gear != "P"

// TODO 4: brake should decrease the car's speed only if engine is on and speed > 5

// Todo 5: exitSimulation should prints a farewell messase using System.exit(0)
