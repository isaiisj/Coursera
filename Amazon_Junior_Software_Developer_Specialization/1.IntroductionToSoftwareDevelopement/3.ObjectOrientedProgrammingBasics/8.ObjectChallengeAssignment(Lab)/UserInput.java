...
public class UserInput {
    ...
    // TODO 5: complete obtainHeight method following obtaingWeight
    ...
    public double obtainHeight(String bmiSystem) {
        ...
        while (isInvalidInput) {
            // Scanner that captures user input for the weight value
            Scanner input = new Scanner(System.in);
            // A Switch statement that determines if weight should be obtained in Inches or Meters based on the BMI system
            switch (bmiSystem.toUpperCase()) {
                // The case of IMPERIAL BMI system
                case "IMPERIAL":
